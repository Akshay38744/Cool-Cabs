<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="VIewProfile.aspx.cs" Inherits="VIewProfile" %>
  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<h1 class="text-3xl font-bold pt-8 lg:pt-0"><%#Eval("username") %></h1>
			<div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
           
			<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"> <img src="Logo/email.png" />  &nbsp; <%#Eval("email") %></p>
            	<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"> <img src="Logo/smartphone.png" /> &nbsp; <%#Eval("Mobile") %></p>
            <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"> <img src="Logo/placeholder.png" /> &nbsp; <%#Eval("Location") %></p>
			
			<p class="pt-8 text-sm">Totally optional short description about yourself, what you do and so on.</p>

			<div class="pt-12 pb-8">
				<button class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
				<asp:Button ID="Button1" CssClass="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full" runat="server" OnClick="Button1_Click" Text="Viewbooking" />
                   
				</button> 
                  <asp:Button ID="btnlogout" class="inline-flex items-center bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0" runat="server" Text="Logout" OnClick="btnlogout_Click" />
			</div>
      ...
      <%--  <asp:ImageButton ID="ImageButton1" runat="server" ImageAlign="Right" ImageUrl="~/img/button_logout.png" OnClick="ImageButton1_Click" />
    <div>
