<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" CodeFile="Login.aspx.cs" Inherits="_Default" %>
	...
	<div class="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
		...
		<div class="mt-8 space-y-6" action="#">	
            <div class="mt-8 content-center">
                ...
                <asp:TextBox ID="txtusername" CssClass="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" runat="server"></asp:TextBox>
            </div>
			...
			<div class="mt-8 content-center">
                ...
                <asp:TextBox ID="txtpassword" CssClass="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" runat="server"></asp:TextBox>
            </div>
            ...
            <div class="mt-8 content-center">
                <label class="text-sm font-bold text-gray-700 tracking-wide">
                 ...
                 <asp:TextBox ID="txtCaptcha" CssClass="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" runat="server"></asp:TextBox>
	...
	<div class="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10">
		...
		<form class="mt-8 space-y-6" action="#" method="POST">
			...
			<div class="relative">
                ...
                <asp:TextBox ID="txtusername" CssClass=" w-full text-base py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" runat="server"></asp:TextBox>
            </div>
			<div class="mt-8 content-center">
				<label class="text-sm font-bold text-gray-700 tracking-wide">
					Password
